...
type HttpApi struct {
	...
	// Required: false
	// See: https://github.com/awslabs/serverless-application-model/blob/master/versions/2016-10-31.md#awsserverlesshttpapi
	AccessLogSettings *HttpApi_AccessLogSettings `json:"AccessLogSettings,omitempty"`

	// Auth AWS CloudFormation Property
	// Required: false
	// See: https://github.com/awslabs/serverless-application-model/blob/master/versions/2016-10-31.md#awsserverlesshttpapi
	Auth *HttpApi_Auth `json:"Auth,omitempty"`
	...
	// Required: false
	// See: https://github.com/awslabs/serverless-application-model/blob/master/versions/2016-10-31.md#awsserverlesshttpapi
	Domain *HttpApi_DomainConfiguration `json:"Domain,omitempty"`
