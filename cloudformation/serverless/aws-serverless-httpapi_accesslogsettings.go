...
// HttpApi_AccessLogSettings AWS CloudFormation Resource (AWS::Serverless::HttpApi.AccessLogSettings)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apigatewayv2-stage-accesslogsettings.html
type HttpApi_AccessLogSettings struct {
...
func (r *HttpApi_AccessLogSettings) AWSCloudFormationType() string {
	return "AWS::Serverless::HttpApi.AccessLogSettings"
}
